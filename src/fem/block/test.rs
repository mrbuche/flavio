macro_rules! test_finite_element_block
{
    ($element: ident) =>
    {
        mod finite_element_block
        {
            ...
            {
                use super::*;
                test_finite_element_block_with_constitutive_model!($element, SaintVenantKirchoffModel, SAINTVENANTKIRCHOFFPARAMETERS);
            }
            pub mod yeoh
            {
                use super::*;
...
macro_rules! test_finite_element_block_with_constitutive_model
{
    ...
    {
        fn get_block<'a>() -> Block<'a, $constitutive_model<'a>, D, E, $element<'a, $constitutive_model<'a>, DeformationGradient>, G, N, DeformationGradient>
        {
            Block::new(
        ...
        fn get_block_transformed<'a>() -> Block<'a, $constitutive_model<'a>, D, E, $element<'a, $constitutive_model<'a>, DeformationGradient>, G, N, DeformationGradient>
        {
            Block::new(
                $constitutive_model_parameters,
                get_connectivity(),
        ...
        {
            assert_eq!(
                std::mem::size_of::<Block<$constitutive_model, D, E, $element::<$constitutive_model, DeformationGradient>, G, N, DeformationGradient>>(),
                std::mem::size_of::<Connectivity<E, N>>()
                + std::mem::size_of::<CurrentNodalCoordinates<D>>()
                + E * std::mem::size_of::<$element::<$constitutive_model, DeformationGradient>>()
            )
        }
    }
}
