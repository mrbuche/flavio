    ...
    Self: FiniteElement<'a, C, G, N>
{
    ...
    fn calculate_inverse_projection_matrix(reference_jacobians_subelements: &Scalars<P>) -> NormalizedProjectionMatrix<Q>
    {
        Self::calculate_shape_function_integrals_products().iter()
        .zip(reference_jacobians_subelements.iter())
        .map(|(shape_function_integrals_products, reference_jacobian_subelement)|
    ...
    fn calculate_reference_jacobians(reference_nodal_coordinates: &ReferenceNodalCoordinates<O>) -> Scalars<G>
    {
        ...
        .zip(Self::calculate_reference_jacobians_subelements(reference_nodal_coordinates).iter())
