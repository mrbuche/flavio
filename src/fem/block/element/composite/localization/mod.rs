...
pub trait CompositeLocalizationElement<'a, C, const G: usize, const M: usize, const N: usize, const O: usize, const P: usize, const Q: usize>
where
    C: Constitutive<'a>,
    Self: CompositeSurfaceElement<'a, C, G, M, N, O, P, Q>
{
    fn calculate_deformation_gradients_composite_localization_element(&self, nodal_coordinates: &NodalCoordinates<N>) -> DeformationGradients<G>
    {
    ...
    fn calculate_deformation_gradient_rates_composite_localization_element(&self, nodal_coordinates: &NodalCoordinates<N>, nodal_velocities: &NodalVelocities<N>) -> DeformationGradientRates<G>
    {
