macro_rules! test_finite_element
{
    ($element: ident) =>
    {
        mod finite_element
        {
            ...
            {
                use super::*;
                test_finite_element_with_constitutive_model!($element, AlmansiHamelModel, ALMANSIHAMELPARAMETERS);
            }
            pub mod arruda_boyce
            {
                use super::*;
                test_finite_element_with_constitutive_model!($element, ArrudaBoyceModel, ARRUDABOYCEPARAMETERS);
            }
            pub mod gent
            {
                use super::*;
