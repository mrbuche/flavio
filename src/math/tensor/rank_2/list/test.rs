...
fn iter_mut()
{
    get_tensor_rank_2_list().iter_mut()
    .zip(get_array().iter_mut())
    .for_each(|(tensor_rank_2_entry, array_entry)|
        tensor_rank_2_entry.iter_mut()
        .zip(array_entry.iter_mut())
        .for_each(|(tensor_rank_2_entry_i, array_entry_i)|
            tensor_rank_2_entry_i.iter_mut()
...
fn zero()
{
    ...
    .for_each(|tensor_rank_2_entry|
        ...
        .for_each(|tensor_rank_2_entry_i|
            tensor_rank_2_entry_i.iter()
            .for_each(|tensor_rank_2_entry_ij|
                assert_eq!(tensor_rank_2_entry_ij, &0.0)
            )
        )
    );
}
