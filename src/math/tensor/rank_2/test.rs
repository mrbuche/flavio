...
use super::
{
    ...
    TensorRank2Trait,
    TensorRank2List2D,
    list_2d::TensorRank2List2DTrait
};
...
fn as_array_dim_2()
{
    get_tensor_rank_2_dim_2().as_array().iter()
    .zip(get_array_dim_2().iter())
    .for_each(|(tensor_rank_2_as_array_i, array_i)|
        tensor_rank_2_as_array_i.iter()
        .zip(array_i.iter())
...
fn as_array_dim_3()
{
    get_tensor_rank_2_dim_3().as_array().iter()
...
fn as_array_dim_4()
{
    get_tensor_rank_2_dim_4().as_array().iter()
...
fn as_array_dim_9()
{
    get_tensor_rank_2_dim_9().as_array().iter()
...
{
    (get_tensor_rank_2_dim_3() * get_tensor_rank_2_list_2d()).iter()
    ...
    .for_each(|(tensor_rank_2_list_2d_entry, res_entry)|
        ...
        .for_each(|(tensor_rank_2, res)|
            ...
            .for_each(|(tensor_rank_2_i, res_i)|
                tensor_rank_2_i.iter()
                .zip(res_i.iter())
                .for_each(|(tensor_rank_2_ij, res_ij)|
                    assert_eq!(tensor_rank_2_ij, res_ij)
                )
            )
        )
    );
