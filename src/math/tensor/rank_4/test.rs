...
fn contract_first_third_fourth_indices_with_first_indices_of()
{
    (get_tensor_rank_4().contract_first_third_fourth_indices_with_first_indices_of(
        &get_tensor_rank_2(), &get_other_tensor_rank_2(), &get_other_other_tensor_rank_2()
    )).iter()
    .zip(get_tensor_rank_4_contract_first_third_fourth_indices_with_first_indices_of_tensor_rank_2().iter())
    .for_each(|(tensor_rank_4_i, res_tensor_rank_4_i)|
        tensor_rank_4_i.iter()
        .zip(res_tensor_rank_4_i.iter())
        .for_each(|(tensor_rank_4_ij, res_tensor_rank_4_ij)|
...
{
    (get_tensor_rank_4().contract_second_index_with_first_index_of(
        &get_tensor_rank_2()
    )).iter()
...
{
    (get_tensor_rank_4() * get_tensor_rank_2()).iter()
