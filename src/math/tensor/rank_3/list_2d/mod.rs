...
pub struct TensorRank3List2D<const D: usize, const I: usize, const J: usize, const K: usize, const W: usize, const X: usize>
(
    [TensorRank3List<D, I, J, K, W>; X]
);

/// Inherent implementation of [`TensorRank3List2D`].
impl<const D: usize, const I: usize, const J: usize, const K: usize, const W: usize, const X: usize> TensorRank3List2D<D, I, J, K, W, X>
{
    /// Returns an iterator.
    ///
...
impl<const D: usize, const I: usize, const J: usize, const K: usize, const W: usize, const X: usize> TensorRank3List2DTrait<D, W, X> for TensorRank3List2D<D, I, J, K, W, X>
{
    fn new(array: [[[[[TensorRank0; D]; D]; D]; W]; X]) -> Self
    {
...
impl<const D: usize, const I: usize, const J: usize, const K: usize, const W: usize, const X: usize> FromIterator<TensorRank3List<D, I, J, K, W>> for TensorRank3List2D<D, I, J, K, W, X>
{
