...
pub struct TensorRank3List3D<const D: usize, const I: usize, const J: usize, const K: usize, const W: usize, const X: usize, const Y: usize>
(
    [TensorRank3List2D<D, I, J, K, W, X>; Y]
);

/// Inherent implementation of [`TensorRank3List3D`].
impl<const D: usize, const I: usize, const J: usize, const K: usize, const W: usize, const X: usize, const Y: usize> TensorRank3List3D<D, I, J, K, W, X, Y>
{
    /// Returns an iterator.
    ///
...
impl<const D: usize, const I: usize, const J: usize, const K: usize, const W: usize, const X: usize, const Y: usize> TensorRank3List3DTrait<D, W, X, Y> for TensorRank3List3D<D, I, J, K, W, X, Y>
{
    fn new(array: [[[MakeClippyHappy<D>; W]; X]; Y]) -> Self
    {
