...
fn iter()
{
    get_tensor_rank_3_list_3d().iter()
    .zip(get_array().iter())
    .for_each(|(tensor_rank_3_list_2d, array)|
        tensor_rank_3_list_2d.iter()
        .zip(array.iter())
...
fn iter_mut()
{
    get_tensor_rank_3_list_3d().iter_mut()
    .zip(get_array().iter_mut())
    .for_each(|(tensor_rank_3_list_2d, array)|
        tensor_rank_3_list_2d.iter_mut()
        .zip(array.iter_mut())
        .for_each(|(tensor_rank_3_list_1d, array_entry)|
            tensor_rank_3_list_1d.iter_mut()
            .zip(array_entry.iter_mut())
            .for_each(|(tensor_rank_3, array)|
                tensor_rank_3.iter_mut()
                .zip(array.iter_mut())
                .for_each(|(tensor_rank_3_i, array_i)|
