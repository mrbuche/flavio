...
impl<'a, C1, C2> ConstitutiveModel<'a> for CompositeHyperelastic<C1, C2>
where
...
impl<'a, C1, C2> Solid<'a> for CompositeHyperelastic<C1, C2>
where
    C1: Solid<'a>,
    C2: Solid<'a>
{}

impl<'a, C1, C2> Elastic<'a> for CompositeHyperelastic<C1, C2>
where
    C1: Elastic<'a>,
    C2: Elastic<'a>
{
...
impl<'a, C1, C2> Hyperelastic<'a> for CompositeHyperelastic<C1, C2>
where
    C1: Hyperelastic<'a>,
    C2: Hyperelastic<'a>
{
...
impl<C1, C2> CompositeConstitutiveModel<C1, C2> for CompositeHyperelastic<C1, C2>
{
