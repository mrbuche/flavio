...
{
    thermelastic_constitutive_model: C1,
...
where
    ...
    C2: ThermalConductionConstitutiveModel<'a>
{
    fn construct(thermelastic_constitutive_model: C1, thermal_conduction_constitutive_model: C2) -> Self
    {
        Self
        {
            thermelastic_constitutive_model,
            thermal_conduction_constitutive_model
        }
    }
    fn get_solid_constitutive_model(&self) -> &C1
    {
        &self.thermelastic_constitutive_model
    }
