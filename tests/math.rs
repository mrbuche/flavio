...
mod public {
    use flavio::math::{
        TensorRank0, TensorRank1, TensorRank1List, TensorRank1List2D, TensorRank2, TensorRank2List,
        TensorRank2List2D, TensorRank3, TensorRank3List, TensorRank3List2D, TensorRank3List3D,
